 ...
 * @constructor
 */
var PointerSchema = new mongoose.Schema({
  index: {
    type: Number,
    required: true
  },
...
PointerSchema.plugin(SchemaOptions);

PointerSchema.index({hash: 1});

PointerSchema.set('toObject', {
 ...
 * @private
 */
PointerSchema.methods._validate = function() {
 ...
 */
PointerSchema.statics.create = function(shard, callback) {
  let Pointer = this;
...
module.exports = function(connection) {
  return connection.model('Pointer', PointerSchema);
};

module.exports.Schema = PointerSchema;

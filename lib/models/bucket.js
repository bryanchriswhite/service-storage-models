...
BucketSchema.plugin(SchemaOptions);
 ...
 */
BucketSchema.statics.create = function(user, data, callback) {
  let Bucket = this;
...
module.exports = function(connection) {
  return connection.model('Bucket', BucketSchema);
};

module.exports.Schema = BucketSchema;

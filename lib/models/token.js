...
TokenSchema.plugin(SchemaOptions, {
...
TokenSchema.methods.expire = function(callback) {
 ...
 */
TokenSchema.statics.create = function(bucket, operation, callback) {
  let Token = this;
  let token = new Token({
    bucket: bucket._id,
    _id: Token.generate(),
 ...
 * @param {Function} callback
 */
TokenSchema.statics.lookup = function(tokenString, callback) {
  let Token = this;

...
const FullAuditSchema = new Schema({
  farmer_id:  {
    type: String,
    required: true
  },
...
FullAuditSchema.statics.scheduleFullAudits = function(
  opts,
  scheduleTransformFn,
  callback
) {
...
FullAuditSchema.statics.defaultScheduleTransform = function(opts, ind) {
...
FullAuditSchema.statics.popReadyAudits = function(callback) {
  var updateQuery = {
    ts: {
      $lte: Date.now()
    },
...
FullAuditSchema.statics.handleAuditResult = function(auditId, result, callback) {
  var updateQuery = {
    _id: auditId
  };
...
module.exports = function(connection) {
  return connection.model('FullAudit', FullAuditSchema);
};

module.exports.Schema = FullAuditSchema;
